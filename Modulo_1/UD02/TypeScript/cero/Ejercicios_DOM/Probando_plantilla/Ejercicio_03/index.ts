let refBody2 : HTMLBodyElement = document.body as HTMLBodyElement;
let elementoDiv : HTMLDivElement = document.createElement("div");
let elementoP : HTMLParagraphElement = document.createElement("p");
...
let botonLeer : HTMLButtonElement = document.createElement("button");
botonLeer.textContent = "Mostrar datos";

refBody2.appendChild(elementoInput);
refBody2.appendChild(botonLeer);

botonLeer.addEventListener("click", ():void =>{
    let paragrafo : HTMLParagraphElement = document.createElement("p");
