...
var elementoLista = ["Une", "Due", "Tre", "Cuatro", "Cinque", "Sei"];
elementoLista.forEach(function (item) {
    var listItem = document.createElement("li");
    listItem.textContent = item;
    lista.appendChild(listItem);
});
var primerElementoLista = lista.querySelectorAll("li")[2]; //la exclamación evita que pete por el nulo
primerElementoLista.addEventListener("click", function () {
    console.log(lista);
    console.log(primerElementoLista.textContent);
});
refBody1.appendChild(lista);
